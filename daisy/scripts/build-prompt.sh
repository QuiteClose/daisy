...
#
# This file is generated by daisy/scripts/build-prompt.sh
# Output: home/$DAISY_HOME_NAME/AGENTS.md
# Do not edit directly - edit source prompts in prompts/ directory
# To rebuild: \$DAISY_ROOT/daisy/scripts/build-prompt.sh $DAISY_HOME_NAME
...
# Report success
echo "✅ Built AGENTS.md for home: $DAISY_HOME_NAME"
